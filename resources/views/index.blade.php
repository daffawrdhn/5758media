      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 d-flex justify-content-start">
            <p><a class="btn btn-outline-primary btn-lg shadow" href="#fact" role="button">Lihat fakta &raquo;</a></p>
          </div>
        </div>
      </div>
    </div>
                ...
                <form action="/sonya" method="GET">
                  ...
                  <div class="row">
                    <div class="col-sm-12 d-flex justify-content-end mt-4">
                      <button type="submit " value="cari" class="btn btn-outline-secondary btn-lg shadow">Cek</button>
                    </div>
                  </div>
                </form>
              </div>
              ...
              <div class="card-body">
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    <button type="button" onclick="getInputNota();" class="btn btn-outline-secondary shadow">Cek</button>
                  </div>
                </div>
              </div>
            </div>
...
<div id="fact" class="container vh-auto d-flex flex-column justify-content-center font-5758" style="min-height: 100vh;">
  <div class="row">
    ...
    <div class="col-sm-6 d-flex flex-column justify-content-center">
      <div class="container">
        <h1 class="display-1 font-weight-bold text-right">Fakta</h1>
        <p class="text-right">Fakta mengenai 5758Media yang harus kalian ketahui sekaligus menjadi transparasi data dan jasa kami kepada client agar semakin percaya.</p>
        <div class="row">
          <div class="col-sm-12 d-flex justify-content-end">
            <p><a class="btn btn-outline-primary btn-lg shadow" href="#panel2" role="button">Lihat harga &raquo;</a></p>
          </div>
        </div>
      </div>
    </div>
...
<div id="panel2" class="container vh-auto d-flex flex-column align-items-center justify-content-center font-5758" style="min-height: 100vh;">
  ...
  <div class="pricing-header px-3 py-5 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4 font-weight-bold">Harga</h1>
  ...
  <div class="card-deck mb-3 text-center">
    <div class="card mb-4 shadow">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">Rp 5.000</small></h1>
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary">Daftar sekarang</button>
      </div>
    </div>
    <div class="card mb-4 shadow">
      <div class="card-header gradient-5758">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">Rp 9.000</h1>
        <ul class="list-unstyled mt-3 mb-4">
        ...
        <button type="button" class="btn btn-lg btn-block btn-primary">Yuk mulai</button>
      </div>
    </div>
    <div class="card mb-4 shadow">
      <div class="card-header gradient-5758">
      ...
      <div class="card-body">
        <h1 class="card-title pricing-card-title">Hubungi</h1>
        <ul class="list-unstyled mt-3 mb-4">
        ...
        <button type="button" class="btn btn-lg btn-block btn-primary">Hubungi</button>
      </div>
    </div>
  </div>
