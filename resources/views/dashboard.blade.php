                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                  ...
                                  @elseif( $o -> status =='2')
                                              ...
                                              <a class="btn btn-lg btn-block btn-outline-danger" href="{{route('rollbackdp', $o->id)}}" role="button">Rollback</a>
                                              <button class="dropdown-item" type="button" data-toggle="modal" data-target="#batal{{$o->id}}">Batalkan</button>
                                  @elseif( $o -> status =='4')
                                                    <button class="dropdown-item" type="button" data-toggle="modal" data-target="#konfirmasijaminan{{$o->id}}">Konfirmasi jaminan</button>
                                                    <a class="btn btn-lg btn-block btn-outline-danger" href="{{route('rollbackpelunasan', $o->id)}}" role="button">Rollback</a>
                        ...
                        <div class="card-footer bg-white">
                          <div class="row">
                            <div class="col-sm-auto text-center border-right">
                              <a href="{{route('nota', $o->id)}}" target="_blank" class="badge badge-primary">Lihat detail order</a>
                            </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('konfirmasiorder',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="konfirmasidp{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('konfirmasidp', $o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="konfirmasijaminan{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('konfirmasijaminan',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="selesai{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('orderselesai',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="hapusorder{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('hapusorder',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="konfirmasipembatalan{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('konfirmasipembatalan',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                      ...
                      <div class="modal fade" id="batal{{$o->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{route('batal',$o->id)}}">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                              ...
                              <div class="col-sm-3 text-center align-self-center">
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                ...
                                                <button class="dropdown-item" type="button" data-toggle="modal" data-target="#batal2{{$o->id}}">Batalkan</button>
                                                <a class="dropdown-item btn btn-lg btn-block btn-outline-danger" href="{{route('rollbackdp', $o->id)}}" role="button">Rollback</a>
                ...
                <div class="card-body">
                  <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="user" role="tabpanel" aria-labelledby="user-tab">
                      ...
                      <div class="card">
                          <div class="row">
                            <div class="col-sm-1 @if($o->usertype=='admin')bg-danger @elseif($o->usertype=='')bg-primary @else bg-primary @endif">
                            </div>
                            <div class="col-sm-8">
                      ...
                      <div class="modal fade" id="edit2{{ $o -> id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{route('editupdate',$o->id)}}" method="POST">
                      ...
                      <div class="modal fade" id="delete2{{ $o -> id }}" tabindex="-1" role="dialog" aria-labelledby="AexampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                              <a class="btn btn-danger" role="button" href="{{route('userdelete', $o->id )}}">Confirm</a>
                            </div>
                          </div>
                        </div>
                      </div>
